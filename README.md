...
The primary runtime is a ChatGPT Project with parallel worker chats. The routine command is:
...
1. [`AGENTS.md`](AGENTS.md) — all-the-way-down worker contract.
2. [`CHATGPT_PROJECT.md`](CHATGPT_PROJECT.md) — exact multi-chat runtime.
3. [`config/autonomy.json`](config/autonomy.json) — machine-readable cadence and merge policy.
4. [`docs/architecture/10-autonomous-runtime.md`](docs/architecture/10-autonomous-runtime.md) — control-loop architecture.
5. [`METHODOLOGY.md`](METHODOLOGY.md) and [`SECURITY_AND_SAFETY.md`](SECURITY_AND_SAFETY.md).
