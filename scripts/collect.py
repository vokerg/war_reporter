...
def public_projection(
    ...
    """Compatibility wrapper for the mandatory archive projection."""
    return archive_projection(item, settings)
...
def run_collection(*args: Any, **kwargs: Any) -> dict[str, Any]:
    """Compatibility wrapper preserving the historical collect patch point."""
